...
function Post({ post }: Props) {
    ...
    { `Approved Comments: ${console.log(post)}` }
        ...
        <main>
            ...
            <article className='max-w-3xl mx-auto p-5'>
                ...
                <div className='flex items-center space-x-2'>
                    <img className='h-20 w-20 object-cover rounded-full' src={urlFor(post.author.image).url()!} alt="" />
                ...
                <div className='mt-10'>
                    <PortableText
                        ...
                        content={post.body}
                        //what happens when it comes across an array of items like H1 H2 etc..
                        serializers={{
                            h1: (props: any) => (
            ...
            <hr className='max-w-lg my5 mx-auto border-yellow-500'></hr>
